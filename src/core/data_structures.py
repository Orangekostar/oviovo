...
class TSDFInstanceVolume:
    ...
    instance_owned_support: Dict[int, Dict[Tuple[int, int, int], float]] = field(default_factory=dict)
    instance_competing_support_mass: Dict[int, float] = field(default_factory=dict)
    voxel_owner_id: Dict[Tuple[int, int, int], int] = field(default_factory=dict)
    owner_index_revision: int = 0
    support_index_valid: bool = False
