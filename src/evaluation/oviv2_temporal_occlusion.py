...
def mechanism_telemetry_from_sources(
    *,
    ...
    if not (
        ...
        and type(runtime_diagnostics.get("processed_frame_count")) is int
        and runtime_diagnostics["processed_frame_count"] == len(frame_coverage)
        ...
        and counters["epoch_reset_trigger_count"]
