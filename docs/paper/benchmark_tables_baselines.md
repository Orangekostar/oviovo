...
| CROVE | online | 0.338 | 0.414 | 0.580 | 0.332 | 0.317 |
...
| CROVE | online | 0.371 | 0.125 | 0.886 | 0.124 | 0.281 | 0.081 | 0.760 |
...
| CROVE | online | {{T2_OVIV2_APARTMENT_OBJECT_F1}} | {{T2_OVIV2_APARTMENT_DYNAMIC_F1}} | {{T2_OVIV2_APARTMENT_CHANGE_F1}} | {{T2_OVIV2_OFFICE_OBJECT_F1}} | {{T2_OVIV2_OFFICE_DYNAMIC_F1}} | {{T2_OVIV2_OFFICE_CHANGE_F1}} |
...
| CROVE | online | {{T2_OVIV2_CURRENT_MIOU}} | {{T2_OVIV2_GHOST_RATE}} | {{T2_OVIV2_BG_F5}} | {{T2_OVIV2_RECOVERY_FRAMES}} |
...
| CROVE (maintenance off) | maintenance-off | {{T4_OVIV2_STATIC_FRONTEND_SPF}} | {{T4_OVIV2_STATIC_BACKEND_SPF}} | {{T4_OVIV2_STATIC_MAINT_SPF}} | {{T4_OVIV2_STATIC_TOTAL_SPF}} | {{T4_OVIV2_STATIC_HZ}} | {{T4_OVIV2_STATIC_FINAL_S}} | {{T4_OVIV2_STATIC_QUERY_P50_MS}} | {{T4_OVIV2_STATIC_QUERY_P95_MS}} |
| CROVE | online | {{T4_OVIV2_FRONTEND_SPF}} | {{T4_OVIV2_BACKEND_SPF}} | {{T4_OVIV2_MAINT_SPF}} | {{T4_OVIV2_TOTAL_SPF}} | {{T4_OVIV2_HZ}} | {{T4_OVIV2_FINAL_S}} | {{T4_OVIV2_QUERY_P50_MS}} | {{T4_OVIV2_QUERY_P95_MS}} |
...
| CROVE (maintenance off) | maintenance-off | {{T4_OVIV2_STATIC_GPU_GB}} | {{T4_OVIV2_STATIC_RAM_GB}} | {{T4_OVIV2_STATIC_MAP_MB}} | {{T4_OVIV2_STATIC_EVAL_IO_S}} |
| CROVE | online | {{T4_OVIV2_GPU_GB}} | {{T4_OVIV2_RAM_GB}} | {{T4_OVIV2_MAP_MB}} | {{T4_OVIV2_EVAL_IO_S}} |
...
| CROVE | online | {{S1_OVIV2_VALIDATION_PRESENT_R1}} | {{S1_OVIV2_VALIDATION_MOVED_R1}} | {{S1_OVIV2_VALIDATION_NEW_R1}} | {{S1_OVIV2_VALIDATION_NOT_FOUND_F1}} | {{S1_OVIV2_VALIDATION_STALE_FP}} | {{S1_OVIV2_VALIDATION_LOC_ERROR_M}} | {{S1_OVIV2_VALIDATION_RECOVERY_FRAMES}} |
...
| CROVE | online | {{S1_OVIV2_TEST_PRESENT_R1}} | {{S1_OVIV2_TEST_MOVED_R1}} | {{S1_OVIV2_TEST_NEW_R1}} | {{S1_OVIV2_TEST_NOT_FOUND_F1}} | {{S1_OVIV2_TEST_STALE_FP}} | {{S1_OVIV2_TEST_LOC_ERROR_M}} | {{S1_OVIV2_TEST_RECOVERY_FRAMES}} |
...
| CROVE (no re-ID) | online | {{S2_OVIV2_NO_REID_STAGE_AP50}} | {{S2_OVIV2_NO_REID_T_AP}} | {{S2_OVIV2_NO_REID_T_REC}} | {{S2_OVIV2_NO_REID_IDSW}} | {{S2_OVIV2_NO_REID_REACT_R1}} | {{S2_OVIV2_NO_REID_FALSE_REID}} |
| CROVE | online | {{S2_OVIV2_STAGE_AP50}} | {{S2_OVIV2_T_AP}} | {{S2_OVIV2_T_REC}} | {{S2_OVIV2_IDSW}} | {{S2_OVIV2_REACT_R1}} | {{S2_OVIV2_FALSE_REID}} |

## Table S3: Absence Reliability and Calibration

**Caption.** Presence and absence reliability on held-out queries. Composed baseline rejectors and CROVE use one validation-only calibration policy serialized before test execution.
...
| CROVE (uncalibrated) | online | {{S3_OVIV2_UNCAL_PRESENCE_AUROC}} | {{S3_OVIV2_UNCAL_NOT_FOUND_PREC}} | {{S3_OVIV2_UNCAL_NOT_FOUND_REC}} | {{S3_OVIV2_UNCAL_NOT_FOUND_F1}} | {{S3_OVIV2_UNCAL_BINARY_ECE}} | {{S3_OVIV2_UNCAL_RISK_COVERAGE_AUC}} |
| CROVE | calibrated | {{S3_OVIV2_PRESENCE_AUROC}} | {{S3_OVIV2_NOT_FOUND_PREC}} | {{S3_OVIV2_NOT_FOUND_REC}} | {{S3_OVIV2_NOT_FOUND_F1}} | {{S3_OVIV2_BINARY_ECE}} | {{S3_OVIV2_RISK_COVERAGE_AUC}} |
