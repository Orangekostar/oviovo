...
def main() -> int:
    ...
    embeddings = np.vstack(
        [entity.semantic_embedding for entity in snapshot.entities if entity.semantic_embedding is not None]
    )
    queries = [
        str(value)
    ...
    model_name = "MobileCLIP-S2" if args.baseline == "dualmap" else "ViT-H-14"
